...
| 7 | **Stakeholder conflicts** | Who wants different things from this? Privacy vs UX? Speed vs correctness? Simplicity vs completeness? |
...
- **Be specific to the subject** — "malformed input" is useless; "transcript with zero speakers but non-empty text" is useful
